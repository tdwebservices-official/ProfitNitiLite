        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12">
          <div class="card border">
            <div class="card-body">
              ...
              @endif                                
              <form method="post" enctype="multipart/form-data" class="financing-report-form" id="financing-report-form">
                @csrf
...
@section('scripts')
<script src="{{asset('assets/js/pages/report/financing-report.js?ver='.time())}}" type="text/javascript"></script>
@endsection