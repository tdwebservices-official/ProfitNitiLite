        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12">
          <div class="card border">
            <div class="card-body">
              ...
              @endif                                
              <form method="post" enctype="multipart/form-data" class="capex-report-form" id="capex-report-form">
                @csrf
...
<div class="col-lg-12 mt-20 balance-sheet-table-box d-none">
        <div class="card">
          <div class="card-header  d-flex align-items-center justify-content-between">
            <h5 class="card-title mb-0">Capex</h5>
        ...
        <div class="card mt-20">
          <div class="card-header">
            <h5 class="card-title mb-0">Return On Capital %</h5>
          </div>
          <div class="card-body">
        ...
        <div class="card mt-20">
          <div class="card-header">
            <h5 class="card-title mb-0">Return On Equity %</h5>
          </div>
          <div class="card-body">
        ...
        <div class="card mt-20">
          <div class="card-header">
            <h5 class="card-title mb-0">Asset Turnover</h5>
          </div>
          <div class="card-body">
...
@section('scripts')
<script src="{{asset('assets/js/pages/report/capex-reports.js?ver='.time())}}" type="text/javascript"></script>
@endsection