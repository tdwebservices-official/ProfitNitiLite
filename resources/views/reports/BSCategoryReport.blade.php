        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12">
          <div class="card border">
            <div class="card-body">
              ...
              @endif                                
              <form method="post" enctype="multipart/form-data" class="bs-category-report-form" id="bs-category-report-form">
                @csrf
...
@section('scripts')
<script src="{{asset('assets/js/pages/report/bs-category-report.js?ver='.time())}}" type="text/javascript"></script>
@endsection