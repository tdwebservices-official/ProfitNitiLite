        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12">
          <div class="card border">
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data" class="pl-report-form" id="pl-report-form">
                @csrf
...
@section('scripts')
<script src="{{asset('assets/js/pages/report/pl-reports.js?ver='.time())}}" type="text/javascript"></script>
@endsection