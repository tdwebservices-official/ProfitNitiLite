...
<link rel="stylesheet" href="{{asset('assets/css/pages/reports/new/financial-summary.css?ver=1234')}}">
@endsection
...
<div class="dashboard-main-body">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <ul class="d-flex align-items-center gap-2">
      ...
      <li>-</li>
      <li class="fw-medium">Financial Summary</li>
    </ul>
  </div>
        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12">
          <div class="card border">
            <div class="card-body">
              ...
              @endif                                
              <form method="post" enctype="multipart/form-data" class="fns-report-form" id="fns-report-form">
                @csrf
...
@section('scripts')
<script src="{{asset('assets/js/pages/report/fns-reports.js?ver='.time())}}" type="text/javascript"></script>
@endsection