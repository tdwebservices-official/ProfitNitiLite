...
@section('content')
  ...
  <ul class="d-flex align-items-center gap-2">
        ...
        <div class="card h-100 p-0 radius-12">
            <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-end">
               <a href="javascript:;" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2 bulk-delete"> 
                ...
                <a href="roles/create" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2"> 
    ...
    @section('scripts')
    <script src="{{asset('assets/js/pages/roles/roleslist.js?ver='.time())}}" type="text/javascript"></script>
    @endsection