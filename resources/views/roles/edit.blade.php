...
@section('content')
  ...
  <ul class="d-flex align-items-center gap-2">
    ...
    <li>-</li>
    <li class="fw-medium">Edit Role</li>
  </ul>
</div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data"  action="{{ route('roles.update', $role->id) }}">
                                     ...
                                     <div class="mb-20">
                                        ...
                                        <input  value="{{ $role->name }}" type="text" class="form-control radius-8" name="name" placeholder="Enter your role name">
                                    </div>
                                    <div class="mb-20">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-switch switch-primary d-flex align-items-center gap-3">
                                                            ...
                                                            value="{{ $permission->name }}"
                                                             {{ in_array($permission->name, $rolePermissions)  ? 'checked' : '' }} class="form-check-input"  role="switch" >
                                                        </div>  
