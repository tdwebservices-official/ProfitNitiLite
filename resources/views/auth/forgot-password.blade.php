...
<head>
  ...
  <title>Forgot Password | ProfitNiti Lite — AI Financial Insights</title>
  ...
  <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
    <div class="max-w-464-px mx-auto w-100">
      ...
      <div>
        ...
        <p class="mb-32 text-secondary-light text-lg">Enter your email and we'll send you a new password.</p>
      </div>
      ...
      <p class="mb-0 text-sm text-secondary-light">
        Redirecting to Sign In in <span id="redirect-countdown">3</span>s…
        <a href="{{ route('login.show') }}" class="text-primary-600 fw-medium">Go now</a>
      </p>
      <meta http-equiv="refresh" content="3;url={{ route('login.show') }}">
      <script>
        (function () {
          var seconds = 3;
    ...
    <form method="post" action="{{ route('forgot-password.send') }}">
       ...
       @csrf
        ...
        <div class="mb-20 text-sm text-secondary-light">
          Remembered your password?
          <a href="{{ route('login.show') }}" class="text-primary-600 fw-medium">Sign In</a>
        </div>

        <button type="submit"
                class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-8">
          Send New Password
        </button>
