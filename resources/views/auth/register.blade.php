...
<head>
  ...
  <title>Sign Up | ProfitNiti Lite — AI Financial Insights</title>
  ...
  <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
    <div class="max-w-464-px mx-auto w-100">
      ...
      <div>
        ...
        <h4 class="mb-12">Create Account 👋</h4>
        <p class="mb-32 text-secondary-light text-lg">Sign up to start tracking what's happening with your money.</p>
      </div>
       ...
       oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,10)">
        ...
        <div class="position-relative mb-20">
          <div class="icon-field">
            ...
            <input type="password"
                   class="form-control h-56-px bg-neutral-50 radius-12"
                   id="your-password-confirm" autocomplete="new-password"
                   name="password_confirmation"
                   placeholder="Confirm Password">
          </div>
          <span class="toggle-password ri-eye-line cursor-pointer position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light"
                data-toggle="#your-password-confirm"></span>
        </div>
