jQuery(document).ready(function($) {
    ...
    $('#add-note-form').validate({
        ...
        submitHandler: function (form) {
            jQuery('#add-note-form button[type="submit"]').siblings('.spinner-border').show();
            $('#add-note-form').ajaxSubmit({
                url: site_url+'/api/storeNote',
                success: function(res) {
                    jQuery('#add-note-form button[type="submit"]').siblings('.spinner-border').hide();
