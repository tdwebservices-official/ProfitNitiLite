jQuery(document).ready(function() {
    ...
    $('#bs-category-report-form').validate({
        ...
        submitHandler: function (form) {
            ...
            jQuery('#bs-category-report-form button[type="submit"]').siblings('.spinner-border').show();
            $('#bs-category-report-form').ajaxSubmit({
            url: site_url+'/api/getBSCategoryReport',
                success: function(res) {
                    jQuery('#bs-category-report-form button[type="submit"]').siblings('.spinner-border').hide();
    ...
    jQuery(document).on( 'click', '.btn-download-report', function () {
         jQuery('#bs-category-report-form .btn-download-report').siblings('.spinner-border').show();
         jQuery('.report_type').val('download');

        $('#bs-category-report-form').ajaxSubmit({
            url: site_url+'/api/getBSCategoryReport',
            success: function(res) {
                jQuery('#bs-category-report-form .btn-download-report').siblings('.spinner-border').hide();
