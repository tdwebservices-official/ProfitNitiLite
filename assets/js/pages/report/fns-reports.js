jQuery(document).ready(function() {
    ...
    $('#fns-report-form').validate({
        ...
        submitHandler: function (form) {
            ...
            jQuery('#fns-report-form button[type="submit"]').siblings('.spinner-border').show();
            $('#fns-report-form').ajaxSubmit({
                url: site_url+'/api/getFNSReportView',
                success: function(res) {
                    jQuery('#fns-report-form button[type="submit"]').siblings('.spinner-border').hide();
    ...
    jQuery(document).on( 'click', '.btn-download-report', function () {
         jQuery('#fns-report-form .btn-download-report').siblings('.spinner-border').show();

        $('#fns-report-form').ajaxSubmit({
            url: site_url+'/api/getFNSReport',
            success: function(res) {
                jQuery('#fns-report-form .btn-download-report').siblings('.spinner-border').hide();
