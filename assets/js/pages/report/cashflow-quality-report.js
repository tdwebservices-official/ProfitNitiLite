jQuery(document).ready(function() {
    ...
    $('#cashflow-quality-report-form').validate({
        ...
        submitHandler: function (form) {
            ...
            jQuery('#cashflow-quality-report-form button[type="submit"]').siblings('.spinner-border').show();
            $('#cashflow-quality-report-form').ajaxSubmit({
            url: site_url+'/api/getCashFlowQualityReport',
                success: function(res) {
                    jQuery('#cashflow-quality-report-form button[type="submit"]').siblings('.spinner-border').hide();
    ...
    jQuery(document).on( 'click', '.btn-download-report', function () {
         jQuery('#cashflow-quality-report-form .btn-download-report').siblings('.spinner-border').show();
         jQuery('.report_type').val('download');

        $('#cashflow-quality-report-form').ajaxSubmit({
            url: site_url+'/api/getCashFlowQualityReport',
            success: function(res) {
                jQuery('#cashflow-quality-report-form .btn-download-report').siblings('.spinner-border').hide();
