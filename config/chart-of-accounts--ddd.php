...
return [
    ...
    'balancesheet_report_list' => [
        [
            'data' => [
                'items' => [
                    'equity_share_capital' => [ 'label' => 'Equity Share Capital', 'bold' => false ],
                    'other_equity' => [ 'label' => 'Other Equity', 'bold' => false ],                    
                    'reserve_surplus' => [ 'label' => 'Reserve & Surplus', 'bold' => false ],                    
                    'current_year_profit' => [ 'label' => 'Current Year Profit', 'bold' => false ],                    
                ],
        ...
        [
            'data' => [
                'items' => [
                    'secured_long_term_borrowings' => [ 'label' => 'Secured Long-term Borrowings', 'bold' => false ],
                    'unsecured_long_term_borrowings' => [ 'label' => 'Unsecured Long-term Borrowings', 'bold' => false ],                    
                    'long_term_provisions' => [ 'label' => 'Long Term Provisions', 'bold' => false ],                    
                    'deferred_tax_liabilities' => [ 'label' => 'Deferred Tax Liabilities', 'bold' => false ],                    
                    'other_non_current_liabilities' => [ 'label' => 'Other Non-Current Liabilities', 'bold' => false ],                    
                ],
        ...
        [
            'data' => [
                'items' => [
                    'secured_short_term_borrowings' => [ 'label' => 'Secured Short-term Borrowings', 'bold' => false ],
                    'accounts_payable' => [ 'label' => 'Accounts Payable', 'bold' => false ],                    
                    'short_term_provisions' => [ 'label' => 'Short Term Provisions', 'bold' => false ],                    
                    'current_deferred_tax_liabilities' => [ 'label' => 'Current Deferred Tax Liabilities', 'bold' => false ],                    
                    'other_current_liabilities' => [ 'label' => 'Other Current Liabilities', 'bold' => false ],                    
                    'difference_in_opening_balance' => [ 'label' => 'Difference in Opening Balance', 'bold' => false ],                    
                ],
        ...
        [
            'data' => [
                'items' => [
                    'fixed_assets' => [ 'label' => 'Fixed Assets', 'bold' => false ],
                    'non_current_investments' => [ 'label' => 'Non-current  Investments', 'bold' => false ],                    
                    'long_term_loans_advances' => [ 'label' => 'Long Term Loans & Advances', 'bold' => false ],                    
                    'deferred_tax_assets' => [ 'label' => 'Deferred Tax Assets', 'bold' => false ],                    
                    'other_non_current_assets' => [ 'label' => 'Other Non-Current Assets', 'bold' => false ],                    
                ],
        ...
        [
            'data' => [
                'items' => [
                    'current_investments' => [ 'label' => 'Current Investments', 'bold' => false ],
                    'closing_stock' => [ 'label' => 'Closing Stock', 'bold' => false ],                    
                    'short_term_loans_advances' => [ 'label' => 'Short Term Loans & Advances', 'bold' => false ],                    
                    'accounts_receivable' => [ 'label' => 'Accounts Receivable', 'bold' => false ],                    
                    'cash_and_bank_balances' => [ 'label' => 'Cash and Bank Balances', 'bold' => false ],                    
                    'other_current_assets' => [ 'label' => 'Other Current Assets', 'bold' => false ],                    
                    'branch' => [ 'label' => 'Branch', 'bold' => false ],                    
                    'suspense' => [ 'label' => 'Suspense', 'bold' => false ],                    
                ],
    ...
    'profitloss_report_list' => [
        'sales' => [ 'label' => 'Sales', 'bold' => false],
        'main_cogs' => [ 'label' => 'COGS', 'bold' => false ], 
        'gross_profit' => [ 'label' => 'Gross Profit', 'bold' => true ], 
        'employee_benefit_expenses' => [ 'label' => 'Employee Benefit Expenses', 'bold' => false ],
        'selling_general_and_administrative_expenses' => [ 'label' => 'Selling, General and Administrative Expenses', 'bold' => false ],                    
        'other_expenses' => [ 'label' => 'Other Expenses', 'bold' => false ],             
        'total_expense' => [ 'label' => 'Total Expenses', 'bold' => true ], 
        'ebita' => [ 'label' => 'EBITDA', 'bold' => true ], 
        'depreciation_amortization' => [ 'label' => 'Depreciation & Amortization', 'bold' => false ],  
        'pbit' => [ 'label' => 'PBIT', 'bold' => true ],      
        'interest_bank_charges' => [ 'label' => 'Interest & Bank Charges', 'bold' => false ],                                        
        'profit_after_interest_tax' => [ 'label' => 'Profit after Interest and before Tax', 'bold' => true ],                                        
        'other_non_operating_income' => [ 'label' => 'Other Non Operating Income',  'bold' => false ],    
        'other_non_operating_expenses' => [ 'label' => 'Other Non Operating Expenses', 'bold' => false ],                                     
        'profit_before_exceptional_taxt' => [ 'label' => 'Profit before Exceptional/Extraordinary Items and Tax', 'bold' => true ],  
        'exceptional_extraordinary_income' => [ 'label' => 'Extraordinary Income', 'bold' => false ],    
        'exceptional_extraordinary_expense' => [ 'label' => 'Extraordinary Expense', 'bold' => false ],   
        'profit_before_tax' => [ 'label' => 'Profit before Tax', 'bold' => true ],   
        'current_tax' => [ 'label' => 'Current Tax', 'bold' => false ],                                        
        'deferred_tax' => [ 'label' => 'Deferred Tax', 'bold' => false ],                                     
        'profit_after_tax' => [ 'label' => 'Profit after Tax', 'bold' => true ],                                     
        'retain_dividend' => [ 'label' => 'Retained Dividend Paid', 'bold' => true ],                                     
        'retain_profit' => [ 'label' => 'Retained Profit', 'bold' => true ],                                     
    ],
   
    'oldnew_financial_summary_report_list' => [
        [
            'data' => [
                'items' => [
     ...
     'new_financial_summary_report_list' => [
        ...
        'main_cogs' => [ 'label' => 'COGS', 'bold' => false ], 
        'gross_profit' => [ 'label' => 'Gross Profit', 'bold' => true ],         
        'overheads' => [ 'label' => 'Overheads', 'bold' => true ], 
        'depreciation_amortization' => [ 'label' => 'Depreciation & Amortization', 'bold' => false ],  
        'operating_profit' => [ 'label' => 'Operating Profit', 'bold' => true ],      
        'interest_bank_charges' => [ 'label' => 'Interest & Bank Charges', 'bold' => false ],                                        
        'profit_after_interest_tax' => [ 'label' => 'Profit after Interest and before Tax', 'bold' => true ],       
        'other_non_operating_income' => [ 'label' => 'Other Income',  'bold' => false ],    
        'other_non_operating_expenses' => [ 'label' => 'Other Expenses', 'bold' => false ],                                     
        'profit_before_exceptional_taxt' => [ 'label' => 'Profit before Exceptional/Extraordinary Items and Tax', 'bold' => true ],  
        'exceptional_extraordinary_income' => [ 'label' => 'Extraordinary Income', 'bold' => false ],    
        'exceptional_extraordinary_expense' => [ 'label' => 'Extraordinary Expense', 'bold' => false ],   
        'profit_before_tax' => [ 'label' => 'Profit before Tax', 'bold' => true ],   
        'tax_paid' => [ 'label' => 'Tax Paid', 'bold' => true ],                                     
        'profit_after_tax' => [ 'label' => 'Profit after Tax', 'bold' => true ],                                     
        'retain_dividend' => [ 'label' => 'Retained Dividend Paid', 'bold' => true ],                                     
        'retain_profit' => [ 'label' => 'Retained Profit', 'bold' => true ],                 
        'cash_and_bank_balances' => [ 'label' => 'Cash & Bank', 'bold' => true ],                 
        'accounts_receivable' => [ 'label' => 'Accounts Receivable', 'bold' => true ],                 
        'closing_stock' => [ 'label' => 'Closing Stock', 'bold' => false ],                 
        'other_current_assets' => [ 'label' => 'Other Current Assets', 'bold' => true ],                 
        'current_assets' => [ 'label' => 'Current Assets', 'bold' => true ],                 
        'fixed_assets' => [ 'label' => 'Fixed Assets', 'bold' => true ],                 
        'other_non_current_assets' => [ 'label' => 'Other Non Current Assets', 'bold' => true ],                 
        'non_current_assets' => [ 'label' => 'Non- Current Assets', 'bold' => true ],                 
        'total_assets' => [ 'label' => 'Total Assets', 'bold' => true ],                 
        'accounts_payable' => [ 'label' => 'Accounts Payable', 'bold' => true ],                 
        'secured_short_term_borrowings' => [ 'label' => 'Bank Loans - Current', 'bold' => true ],                 
        'other_current_liabilities' => [ 'label' => 'Other Current Liabilities', 'bold' => true ],                 
        'current_liabilities' => [ 'label' => 'Current Liabilities', 'bold' => true ],                 
        'bank_load_non_current' => [ 'label' => 'Bank Loans - Non Current', 'bold' => true ],                 
        'other_non_current_liabilities' => [ 'label' => 'Other Non Current Liabilities', 'bold' => true ],                 
        'non_current_liabilities' => [ 'label' => 'Non-Current Liabilities', 'bold' => true ],                 
        'total_liabilities' => [ 'label' => 'Total Liabilities', 'bold' => true ],            
        'equity' => [ 'label' => 'Equity', 'bold' => true ],                 
        'validation' => [ 'label' => 'Validation', 'bold' => false ],                 
    ],
