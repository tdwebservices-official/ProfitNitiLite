...
if ($return_data == 1) {
    ...
    public function getAIReport(Request $request){
        ...
        if( $step_action == 0 ) {
            ...
            $systemPrompt = [
                'role' => 'system',
                'content' => 'You are Profit Niti AI, a virtual CFO who converts financial data into simple, actionable business stories. You MUST follow the exact HTML structure provided for each section. Return only the HTML content without any wrapper tags.'
            ];
            // $systemPromptExtra = '';
            // $industry_name = isset($industry_data->name) ? $industry_data->name : '';
            // $industry_category = isset($industry_data->category) ? $industry_data->category : '';
            // if( $industry_name || $industry_category ){
            //     $systemPromptExtra = 'IMPORTANT: Your analysis and summaries must be specifically tailored to the industry context provided. Based on this "Industry: '.$industry_name.' | Category: '.$industry_category.'", You must always provide summery based on relavent industry not out side of industry.';
            // }
            
            // $systemPrompt = [
            //     'role' => 'system',
            //     'content' => 'You are Profit Niti AI, a virtual CFO based in India who converts financial data into simple, actionable business stories for Indian businesses. You naturally use terms like **lakh, crore, FY, turnover, vendor, debtor, capex, opex, ROCE,** and **working capital**. You MUST follow the exact HTML structure provided for each section. Return only the HTML content without any wrapper tags. All amounts should be in Indian Rupees (₹). All describe content may use india english language easy to read.'. $systemPromptExtra
            // ];
            ...
            if( $industry_name || $industry_category ){
                ...
                **INDUSTRY CONTEXT**: Industry: '.$industry_name.' | Category: '.$industry_category.'
                
                **DATA STRUCTURE NOTES**:
                1. Data is organized as array of metrics, each with "label" and "monthwise_data"
                2. Each monthwise_data has "date" and "value" (string numbers)
                3. Use EXACT dates and values as provided
                4. Convert string values to numbers for calculations: (float)$value
                5. Recognize that same value across months means no change
                6. Dates may vary - detect earliest and latest dynamically
                7. For '.$industry_name.', interpret financial patterns based on actual date ranges';
            }
            ...
            $systemPrompt = [
                ...
                **CRITICAL DATA ACCURACY RULES FOR YOUR DATA FORMAT:**
                ...
                9. Report exactly: "Data covers [earliest month] to [latest month] ([count] months)"' . $systemPromptExtra
            ];
        
        $section1Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_report_data) . "\n\n" .
        ...
        $section2Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_report_data['profit_power_list']) . "\n\n" .
        ...
        $section3Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_report_data['cashflow_sheetdata']) . "\n\n" .
        ...
        $section4Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_report_data['cashmng_list']) . "\n\n" .
        ...
        $section7Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_report_data['bl_sheetdata']) . "\n\n" .
        ...
        $section9Prompt = [
            'role' => 'user',
            'content' =>
                "Here is financial data: " . json_encode($all_inventory_data) . "\n\n" .
        ...
        // $section1Prompt = [
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 1 (Big Picture) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">1. Big Picture — How the Business Looks Right Now</h2>
        //     <div id="overview" style="margin-bottom: 20px;">
        //     <!-- Provide 3-4 sentence overview of overall performance based on data -->
        //     </div>

        //     <div style="background-color: #f0f9f0; border-left: 4px solid #28a745; padding: 15px; margin: 15px 0;">
        //     <h3 style="color: #155724; margin-top: 0;">📗 GREEN FLAG BOX — What\'s Working Well:</h3>
        //     <ul style="margin-bottom: 0;">
        //     <!-- 3 specific positive points from data -->
        //     </ul>
        //     </div>

        //     <div style="background-color: #fef0f0; border-left: 4px solid #dc3545; padding: 15px; margin: 15px 0;">
        //     <h3 style="color: #721c24; margin-top: 0;">📕 RED FLAG BOX — What Needs Attention:</h3>
        //     <ul style="margin-bottom: 0;">
        ...
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentence direct advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 2 (Profit Power) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">2. Profit Power — The Earning Engine</h2>
        //     <div id="profit-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain profit drivers, profitable products, expense issues from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific profit advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 3 (Cash Flow Quality) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">3. Cash Flow Quality — Profit vs Real Cash</h2>
        //     <div id="cash-flow-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain profit to cash conversion, cash blockages from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific cash flow advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 4 (Cash Management) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">4. Cash Management — Daily Cash Rhythm</h2>
        //     <div id="cash-rhythm-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain DSO, DPO, DIO, cash cycle status from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific cash management advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 5 (Growth Investments) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">5. Growth Investments — Where Money Is Going</h2>
        //     <div id="investment-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain investments, ROI, underused assets from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific investment advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 6 (Funding Story) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">6. Funding Story — How Growth Is Being Financed</h2>
        //     <div id="funding-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain loan vs equity, interest costs, debt impact from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific funding advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 7 (Balance Sheet Health) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">7. Balance Sheet Health — Financial Fitness</h2>
        //     <div id="balance-sheet-analysis" style="margin-bottom: 20px;">
        //     <!-- Explain asset-liability balance, key ratios with 🟢🟡🔴 ratings from data -->
        //     </div>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <strong>Advice:</strong>
        //     <p style="margin: 10px 0 0 0;"><!-- 1-2 sentences specific balance sheet advice --></p>
        //     </div>
        //     </section>'
        // ];
        ...
        // $section8Prompt = [
        //     'role' => 'user',
        //     'content' => "Based on previous analysis, generate ONLY Section 8 (AI Simulation) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">8. Smart AI Simulation — Automatic "What-If" Scenarios</h2>
        //     <div style="background-color: #fff3e0; border-left: 4px solid #ff9800; padding: 15px;">
        //     <p style="margin-top: 0;"><em>Based on the weak spots identified, the AI has run these simulations:</em></p>
        //     <ul style="margin-bottom: 0;">
        //     <li><strong>Scenario A – Profit Focus:</strong> [Describe profit simulation based on data]</li>
        //     <li><strong>Scenario B – Cash Focus:</strong> [Describe cash simulation based on data]</li>
        //     <li><strong>Scenario C – Balanced:</strong> [Describe combined simulation based on data]</li>
        //     </ul>
        //     </div>
        //     </section>'
        // ];
        ...
        //     'role' => 'user',
        //     'content' => "Here is financial data: " . json_encode($all_report_data) . 
        //     "\n\nGenerate ONLY Section 9 (Operational Insights) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">9. Operational Insight Engine — Ground-Level Trends</h2>
        //     <div id="operational-analysis">
        //     <!-- Provide narrative on sales patterns, customer behavior, inventory issues from data -->
        //     </div>
        //     </section>'
        // ];
        ...
        // $section10Prompt = [
        //     'role' => 'user',
        //     'content' => "Based on all previous analysis, generate ONLY Section 10 (Action Plan) with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">10. 90-Day CFO Action Plan</h2>
        //     <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
        //     <thead>
        //     <tr>
        //     <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f8f9fa;">Days</th>
        //     <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f8f9fa;">Focus</th>
        //     <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f8f9fa;">Action</th>
        //     <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f8f9fa;">Target</th>
        //     <th style="border: 1px solid #ddd; padding: 12px; text-align: left; background-color: #f8f9fa;">Benefit</th>
        //     </tr>
        //     </thead>
        //     <tbody>
        //     <tr>
        //     <td style="border: 1px solid #ddd; padding: 12px;">0-30</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">Cash</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Specific cash action from analysis]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Measurable target]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Quantified benefit]</td>
        //     </tr>
        //     <tr>
        //     <td style="border: 1px solid #ddd; padding: 12px;">31-60</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">Profit</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Specific profit action from analysis]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Measurable target]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Quantified benefit]</td>
        //     </tr>
        //     <tr>
        //     <td style="border: 1px solid #ddd; padding: 12px;">61-90</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">Growth</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Specific growth action from analysis]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Measurable target]</td>
        //     <td style="border: 1px solid #ddd; padding: 12px;">[Quantified benefit]</td>
        //     </tr>
        //     </tbody>
        ...
        //     <h4 style="margin: 0 0 10px 0;">Action Timeline Bar:</h4>
        //     <div style="background: #4caf50; color: white; padding: 5px; margin: 2px 0; border-radius: 3px; width: 33%;">Cash (0-30 Days)</div>
        //     <div style="background: #2196f3; color: white; padding: 5px; margin: 2px 0; border-radius: 3px; width: 33%;">Profit (31-60 Days)</div>
        //     <div style="background: #ff9800; color: white; padding: 5px; margin: 2px 0; border-radius: 3px; width: 34%;">Growth (61-90 Days)</div>
        //     </div>
        //     </section>'
        // ];
        ...
        // $summaryPrompt = [
        //     'role' => 'user',
        //     'content' => "Based on all analysis, generate ONLY the Final Summary with this exact HTML:\n\n" .
        //     '<section style="margin-bottom: 30px; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        //     <h2 style="color: #2c3e50; border-bottom: 1px solid #eee; padding-bottom: 10px;">🔚 Final Summary</h2>
        //     <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px;">
        //     <p style="margin: 0;">"[One strong closing statement summarizing key findings]"</p>
        //     </div>
        //     </section>'
        // ];
